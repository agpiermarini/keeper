...
context 'User' do
  context 'navigates to user endpoint of account with sufficient tweets and clicks button to retrieve profile' do
    it 'and is directed to profile page with profile information' do
      VCR.use_cassette("personality-profile-endpoint-sufficient-tweets") do
        visit '/turingschool'
